...
# a "compare-free" version - kick the "compare" neuron out, add an extra layer for fun
...
interneuron_types = Dict("accum"=>sum_dicts, "norm"=>max_norm,
                         "dot"=>dot_product_dicts)

for layer in 1:n_layers
    for k in 1:n_per_layer
        for neuron_type_name in ["accum", "norm", "dot"]
...
#     REMOVED: compare_scalars: dict-1, dict-2 => true, false
#
#     const_1: () => const_1
#     const_end: () => char
#
